...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Grafica General</li>
    ...
    <div class="box">
      ...
      <div class="box-body">
       ...
       <?php 
        ...
        $result = ControladorGraficas::General(); 
        $result2 = ControladorGraficas::General2(); 
        $result3 = ControladorGraficas::General3(); 
...
<?php 
// AGREGAR CARRERA
  include "Modales/modal_version/modal_agregarVersion.php";

// EDITAR CARRERA
  include "Modales/modal_version/modal_editarVersion.php"; 
